...
class CheckUpListJovensScreen extends StatefulWidget {
  String listjovenstitle, listjovenstitleABV, listjovensdescription;
  CheckUpListJovensScreen(
      {super.key,
      required this.listjovenstitle,
      required this.listjovenstitleABV,
      required this.listjovensdescription});

  @override
  State<CheckUpListJovensScreen> createState() => _CheckUpListJovensScreenState();
}

class _CheckUpListJovensScreenState extends State<CheckUpListJovensScreen> {
  ...
  void initState() {
    super.initState();
    fromAsset('assets/documents/checkLists/IamInControl_Checklist_Jovens_PT.pdf',
            'IamInControl_Checklist_Jovens_PT.pdf')
        .then((f) {
      setState(() {
        pathPDF = f.path;
      });
                  ...
                  Row(
                    children: [
                      Padding(
                        ...
                        child: Text(widget.listjovenstitleABV,
                            style: TextStyle(
                                fontSize: 30,
                                color: Colors.black,
                                fontWeight: FontWeight.bold)),
                  ...
                  Row(
                    children: [
                      Padding(
                        ...
                        child: Text(widget.listjovenstitle,
                            style: TextStyle(
                              fontSize: 20,
                              color: Colors.black,
                            )),
                              ...
                              child: Column(
                                children: <Widget>[
                                  Padding(
                                    ...
                                    child: Text(widget.listjovensdescription,
                                        style: TextStyle(
                                            fontFamily: 'lato',
                                            fontSize: 17,
                                            color: Colors.black)),
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(context,
                          ...
                          return CheckUpListJovensQuestions();
                        }));
                      },
                      child: Padding(
                        padding: const EdgeInsets.only(
...
class _PDFScreenState extends State<PDFScreen> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Documentação Check List Jovens"),
        actions: <Widget>[
          IconButton(
...
class CheckUpListJovensQuestions extends StatefulWidget {
  const CheckUpListJovensQuestions({super.key});

  @override
  State<CheckUpListJovensQuestions> createState() =>
      _CheckUpListJovensQuestionsState();
}

class _CheckUpListJovensQuestionsState
    extends State<CheckUpListJovensQuestions> {
  late Future _questions;

  Future<List<Option>> getData() async {
    return getQuestionsListJovens();
  }
  ...
  String? listjovensResultOtion01 = "";
  String? listjovensResultOtion02 = "";
  String? listjovensResultOtion03 = "";
      ...
      (snapshot) async {
        ...
        if (snapshot.exists) {
          setState(() {
            ...
            listjovensResultOtion01 = snapshot.data()!["resultOption1"];
            listjovensResultOtion02 = snapshot.data()!["resultOption2"];
            listjovensResultOtion03 = snapshot.data()!["resultOption3"];
          });
        } else {}
        });
      },
  ...
  Future setResult(int questionsLength) async {
    if (score <= 3) {
      FinalTextScore = listjovensResultOtion01!;
      TextScore = '$score / 15';
    } else if (score >= 4 && score <= 8) {
      FinalTextScore = listjovensResultOtion02!;
      TextScore = '$score / 15';
    } else if (score >= 9 && score <= 15) {
      FinalTextScore = listjovensResultOtion03!;
      TextScore = '$score / 15';
    }
  }
